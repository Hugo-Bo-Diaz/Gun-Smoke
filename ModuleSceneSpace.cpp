...
bool ModuleSceneSpace::Start()
{
	...
	App->barrel->AddBarrel(155, 681 - 2815, POWERUP_HORSE); //Aquí está el caballo (sus coordenadas son x = 416, y =1856 , w =16 , h =16 )
	App->barrel->AddBarrel(155, 713 - 2815, POWERUP_RIFLE);
	App->barrel->AddBarrel(52, 904 - 2815, POWERUP_SCORE);  //Aquí hay una botella que te da +1000 puntos al pillarlo (Las coordenadas de la botella son x = 322, y =1882 , w =12 , h =13 )
	App->barrel->AddBarrel(52, 1057 - 2815, POWERUP_SCORE); //Aquí hay una botella que te da +1000 puntos al pillarlo (Las coordenadas de la botella son x = 322, y =1882 , w =12 , h =13 )
	App->barrel->AddBarrel(52, 1073 - 2815, POWERUP_SCORE); //Aquí hay una botella que te da +1000 puntos al pillarlo (Las coordenadas de la botella son x = 322, y =1882 , w =12 , h =13 )
	App->barrel->AddBarrel(52, 1089 - 2815, POWERUP_SCORE); //Aquí hay un saco que te da +1000 puntos al pillarlo (Las coordenadas del saco son x = 297, y =1883 , w =14 , h =14 )
